# Generated by Django 3.0 on 2020-06-23 09:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction', models.CharField(choices=[('LOVE', 'LOVE'), ('WOW', 'WOW'), ('HAHA', 'HAHA'), ('LIT', 'LIT'), ('SAD', 'SAD'), ('ANGRY', 'ANGRY'), ('THUMBS-UP', 'THUMBS-UP'), ('THUMBS-DOWN', 'THUMBS-DOWN')], max_length=100)),
